...
{
    // Singleton instance
    static let shared = SQLite(databaseName: "MyDiary")
     ...
     */
    private init(databaseName dbName:String)
    {
...
//    }
     ...
     */
    public func createTableWithQuery(_ createTableQuery:String, tableName:String)
    {
        /*
    ...
    public func insertWithQuery(_ insertStatementQuery : String, bindingFunction:(_ insertStatement: OpaquePointer?)->())
    {
        /*
